...
%We also observe that by summing over all updates with respect to a single postsynaptic neuron, as with Oja's rule, any neuron's total afferent weight is expected to remain constant.
