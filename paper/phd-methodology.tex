...
\end{python}
We remark that $\textasciitilde z$ is a dynamical primitive in NengoLib that implements a single time-step delay, in correspondance with the $z$-transform in signal processing.
...
This section has been adapted from \citet{voelker2014a}, and discusses the dynamics of a learning rule used by \citet{voelker2014controlling}, \citet{trujillo2014a}, and \citet{aubin2016a}.
