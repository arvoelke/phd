...
Such potential energy savings are not only tremendous, but a prerequisite to reach the exascale level of computation achieved by the human brain, unless one has access to a nuclear power plant producing at least \numprint{e9}\ watts~\citep{furber2012build}.
