...
The next largest (non-NEF) RNN that we can find with published numbers is a ``large scale'' speech recognition example from Google, consisting of \numprint{6800} units in its largest instantiation~\citep[][Table~1]{sak2014long}.
