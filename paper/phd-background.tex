...
Spikey, BrainScaleS~\citep{schemmel2010wafer, aamir2018mixed, aamir2018accelerated}, SyNAPSE, DYNAPs~\citep{moradi2018scalable}, TrueNorth~\citep{merolla2014million}, DeepSouth, COLAMN~\citep{wijekoon2012vlsi}, ODIN~\citep{frenkel2018}, ROLLS~\citep{qiao2015reconfigurable, glatz2018adaptive}, Tripp, Wang and Tapson, STPU, Neuromemristive random projection networks (Dhireesha Kudithipudi)
...
Multiple proposals are currently being investigated to explore the utility of integrating memristive devices into mixed-signal architectures as a compact and non-volatile (i.e.,~maintains memory without power) computational element~\citep{chang2013building, kudithipudi2016design, payvand2018neuromorphic, cady2018full}.
