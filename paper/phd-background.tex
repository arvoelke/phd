...
The term \emph{neuromorphic computing} (a.k.a.,~neuromorphic engineering) refers broadly to the use of specialized hardware that emulates computational principles of biological nervous systems~\citep{mead1989analog, liu2002analog}.
...
Such power savings are potentially tremendous, estimated to be on the order of a \numprint{e3}--\numprint{e5}-fold increase in efficiency over conventional architectures, using currently available analog and digital technology -- a requirement to reach the exascale level of computation achieved by the human brain, unless one has access to a nuclear power plant producing at least \numprint{e9}\ watts~\citep{furber2012build}.
