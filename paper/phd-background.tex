...
This is further connected to the existence of nonlinear chaos in the dynamics of three (or more) recurrently coupled neurons; any correction to the trajectory of the network's state is exponentially magnified over time~\citep{strogatz2000nonlinear}.
...
The work of \citet{jozefowicz2015empirical} explored \numprint{10000} related architectures and \numprint{23000} hyperparameter configurations via evolutionary mutations to the LSTM's computational graph and found none to be consistently better than LSTMs.
...
The hardware promises to improve upon the speed- and power-efficiency of the first generation by use of improved fabrication processes, advanced per-core power management techniques, and specialized hardware acceleration for the exponential function~\citep{partzsch2017fixed}.
