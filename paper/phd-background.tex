...
Multiplicative gating controls whether the input should be integrated, whether the memory is to decay with some leakage, and whether the contents of the memory should be outputted.
...
A spiking analog to LSTMs has also been proposed by \citet{bellec2018long}, in which adaptive neurons take on the role of an LSTM cell, since the adaptive state of the neuron is essentially a controlled leaky integrator.
