...
State-of-the-art is on the verge of reaching this level of performance, with Braindrop, Loihi, and TrueNorth~\citep{merolla2014million}, all coming within a factor of \numprint{e1}--\numprint{e3} for roughly equivalent measures of energy per synaptic operation for typical network configurations~\citep{braindrop2019}.
...
In this scenario SpiNNaker was outperformed by NEST running on an HPC cluster.
