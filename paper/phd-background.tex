...
Promising investigations are currently underway to explore the utility of integrating memristive devices into mixed-signal architectures as a compact and non-volatile (i.e.,~maintains memory without power) computational element~\citep{payvand2018neuromorphic, cady2018full}.
