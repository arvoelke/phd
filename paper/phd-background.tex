...
A review that focuses on feed-forward architectures is given by \citet{pfeiffer2018deep}, while an example applied to RNNs is given by \citet{diehl2016conversion}.
...
Meanwhile, the flexibility of the NEF has lead to it being deployed on mixed-analog-digital neuromorphic chips~\citep{choudhary2012silicon, corradi2014, voelker2017iscas, voelker2017neuromorphic, braindrop2019} and digital architectures~\citep{bekolay2014, wang2014compact, mundy2015, knight2016, berzish2016, wang2017neuromorphic, blouw2018a}.
...
\TODO{Comprehensive literature review on what Loihi is being used for.}
...
Spikey, BrainScaleS~\citep{schemmel2010wafer, aamir2018accelerated}, SyNAPSE, DYNAPs~\citep{moradi2018scalable}, TrueNorth~\citep{merolla2014million, fischl2018}, DeepSouth, COLAMN, ODIN~\citep{frenkel2018}, ROLLS~\citep{qiao2015reconfigurable, glatz2018adaptive}, Giacomo and Eliasmith, Tripp, Wang and Tapson, STPU, Neuromemristive random projection networks (Dhireesha Kudithipudi)
\TODO{\url{https://link.springer.com/chapter/10.1007/978-3-642-00641-8_38}}
DANNA~\citep{daffron2016extensions, mitchell2018danna},
and other VLSI prototypes~\citep{binas2016precise}.
...
TrueNorth results \citep{esser2016convolutional} and ``Supervised Learning Based on Temporal Coding in Spiking Neural Networks''.
...
Promising investigations are currently underway to explore the utility of integrating memristive devices into mixed-signal architectures as a compact and non-volatile (i.e.,~maintains memory without power) computational element~\citep{chang2013building, payvand2018neuromorphic, cady2018full}.

Likewise, many other unconventional implementations of SNNs are currently being considered, such as nanoscale spintronic oscillators and multiferroic devices~\citep{torrejon2017neuromorphic, hoppensteadt2017applied, manipatruni2018beyond}, analog non-volatile memory~\citep{ambrogio2018equivalent}, organic electronics~\citep{van2018organic}, and superconducting circuits based on quantum phase-slip junctions~\citep[QPSJs;][]{cheng2019superconducting}.
