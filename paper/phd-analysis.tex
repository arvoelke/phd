...
$\V{d}_i^\V{f}$ that are independently distributed according to $\mathcal{N}(0, \sigma^2)$ where $\sigma \propto n^{-1}$ -- i.e., variance scales as $\bigoh{n^{-2}}$.
Finally we use the fact that $\eta(t)$ has an expected value of zero.
Therefore,
\begin{equation}
\begin{aligned}
