...
B = \begin{pmatrix*}[r] 1 \\ -3 \\ 5 \\ -7 \\ 9 \\ -11\end{pmatrix*} 
% C = \begin{pmatrix} 1 & 1 & 1 & 1 & 1 & 1 \end{pmatrix} 
\end{equation}

\begin{equation}
\tilde{\mathcal{P}}_i(r) = (-1)^i \sum_{j=0}^i \begin{pmatrix}i \\ j\end{pmatrix} \begin{pmatrix}i + j \\ j\end{pmatrix} \left( -r \right)^j = \mathcal{P}\left( 2 r - 1\right) \text{,} \quad r = \frac{\theta'}{\theta}
\end{equation}
