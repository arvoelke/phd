...
The choice of a zero-frequency approximation is informed by our analysis from section~\ref{sec:energy-minimization} that suggest neural systems require energy that is linear in representational frequency.
