...
In this section we address several fundamental questions regarding the scalability of the Delay Network~(DN) with respect to $q$, $\theta$, and the complex frequency of the input signal, $s = 2 \pi i f$, for some real frequency, $f$.
...
On the other hand, longer values of $\theta$ are more suspeciptible to the integration of spiking noise, in the form of ``drift''.
