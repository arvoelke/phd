...
However, we found that simply modifying the target signal to be a delayed version of a low-frequency signal, posed a significant challenge to these networks.
...
4x Nvidia Titan Xp GPUs with 12GB each
