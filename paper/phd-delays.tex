...
Also mention \citep{bai2018dfr} as an example of the power of delayed reservoirs.
Autoencoder in time.}
...
\TODO{\citep{blumensath2009sampling} and relationship to how spikes are like a way of sampling and then reconstructing as in compressed sensing over time; at the same time cite the sigma delta modulator papers}
