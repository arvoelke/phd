...
By virtue of emulating core principles of brain function, this realizes algorithms that consume far less power, and scale much more readily to massively-parallelized computing architectures running in biological real-time.
...
Nevertheless, this points towards a broader underlying concern: time is not being treated as a fundamental unit of computation in many of the most successful methods, which may limit their applicability to many real-world problems.
...
Everything and everyone that we connect with plays a part in what we become.
This occurs so naturally that we often take it for granted, but our brains are constructing explicit and implicit dynamical models of reality, and applying these models
...
Most impressively of all, the collection of approximately one-hundred billion neurons, connected by over one-hundred trillion synapses, process these signals sparsely across space and time using around $20$\,W~\citep{koch2014} -- about the same energy as a typical household CFL bulb.
