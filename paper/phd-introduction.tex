...
Based on these same principles, we develop theory connecting the mathematical contributions of Henri Pad\'e and Adrien-Marie Legendre, to reveal a new recurrent architecture that can predict chaotic time-series with greater memory capacity and performance surpassing state-of-the-art recurrent neural networks, including Long Short-Term Memory~(LSTM), Reservoir Computing~(RC), and ``FORCE'' networks.
