...
These networks serve as \emph{powerful} models of computation, capable in theory of everything that we can do, while consuming extraordinarily low amounts of power.
In particular, biological nervous systems already leverage the computational power of SNNs quite successfully, and so we seek to borrow existing
...
We have already learned a great deal through the co-design of neuromorphic hardware and spiking algorithms.
...
It is difficult to comprehend the sheer magnitude of this number; one-hundred trillion is more than available estimates on: the number of galaxies in the observable universe, trees on the earth, fish in the ocean, and digits of $\pi$ that have been computed -- all combined (at the time of writing).
}
